...
যদি নতুন পথ shortest এর থেকে ছোট হয়:

নতুন shortest সেট করো
পুরনো shortest কপি করে second-shortest বানাও
যদি shortest < নতুন পথ < second-shortest:
...
🧪 Example
Input
2 3 3 1 2 100 2 3 200 1 3 50 4 4 1 2 100 2 4 200 2 3 250 3 4 100

Output
Case 1: 150 Case 2: 450
...
Test Case
1 4 4 1 2 100 2 4 200 2 3 250 3 4 100

Goal: Find the second-shortest path from 1 → 4.

Graph (ASCII)
(1)---100---(2)---200---(4) | 250 | (3) (3)---100---(4)
...
3 → 4 = 100
Initial State
dist1 = [inf, 0, inf, inf, inf] // 1-based nodes dist2 = [inf, inf, inf, inf, inf] Priority Queue = {(0,1)}
...
dist1 = [inf, 0, 100, inf, inf] dist2 = [inf, inf, inf, inf, inf] PQ = {(100,2)}
...
dist1 = [inf, 0, 100, 350, 300] dist2 = [inf, 200, inf, inf, inf] PQ = {(200,1), (300,4), (350,3)}
...
dist1 = [inf, 0, 100, 350, 300] dist2 = [inf, 200, 300, inf, inf] PQ = {(300,2), (300,4), (350,3)}
...
dist1 = [inf, 0, 100, 350, 300] dist2 = [inf, 200, 300, 550, 500] PQ = {(300,4), (350,3), (500,4), (550,3)}
...
dist1 = [inf, 0, 100, 350, 300] dist2 = [inf, 200, 300, 400, 500] PQ = {(350,3), (400,3), (500,4), (550,3)}
...
dist1 = [inf, 0, 100, 350, 300] dist2 = [inf, 200, 300, 400, 450] PQ = {(400,3), (450,4), (500,4), (550,3)}
